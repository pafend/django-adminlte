...
Open-source **[Django Dashboard](https://appseed.us/admin-dashboards/django)** generated by AppSeed op top of an iconic design. For newcomers, **[AdminLTE](https://appseed.us/admin-dashboards/django-dashboard-adminlte)** is one of the best open-source admin dashboard & control panel theme. Built on top of Bootstrap, AdminLTE provides a range of responsive, reusable, and commonly used components. **Django** is a high-level Python Web framework that encourages rapid development and clean, pragmatic design.
...
- 👉 [AdminLTE Django](https://docs.appseed.us/products/django-dashboards/adminlte) - product documentation
...
## ✨ How to use it with hetzner cloud
